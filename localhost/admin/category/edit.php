<?php
	...
	include $_SERVER['DOCUMENT_ROOT'].'/app/controllers/category_controller/category_controller_edit.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="row my-3">
					...
					<div class="posts col-12 col-md-7 p-0">
						...
						<div class="row  add-post mt-1">
							<form style="padding: 0  13px;"   class=" col-12" method="post" action="/admin/category/edit.php">
