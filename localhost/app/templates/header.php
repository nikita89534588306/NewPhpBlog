					...
					<?php if(isset($_SESSION['id'])):?>		
						...
						<ul class="user-action">
							<?php if($_SESSION['name_role']=="admin"):?>
								<li class="navbar-item"><a class="navbar-link" href="/admin/posts/index.php">Админ панель</a></li>
							<?php endif; ?>
							<li class="navbar-item"><a class="navbar-link" href="/app/database/logout.php">Выход из аккаунта</a></li>
						</ul>
					<?php else: ?>
